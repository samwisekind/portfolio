...
@section ('content')
	...
	<main class="about">
		...
		<div class="wrapper">
			...
			<p class="large">I am Sam, a web developer &amp; designer based in <span class="highlight">Hong Kong</span>. I love obsessing over <span class="highlight red">optimisation</span>, <span class="highlight blue">performance</span>, and <span class="highlight orange">accessibility</span> — using as <span class="highlight red">few bytes &amp; requests</span> as possible to deliver <span class="highlight blue">silky-smooth experiences</span> to as <span class="highlight orange">many people as possible</span>.</p>
