...
@section ('project-content')
	...
	<p>The printing server was run on several laptops connected to high-speed photo printers. The server was built using <a href="https://www.angularjs.org/" target="_blank" rel="noopener noreferrer" class="external">AngularJS</a> that would listen for HTTP requests respective to its printer ID on the local area network. Requests would be added to a queue which filtered duplicate requests.</p>
