...
@section ('project-content')
	...
	@component('components.projects.project-caption')
		...
		@slot('caption')
			Users could upload images which were previewed on the front-end by using the <code>new FileReader()</code> API and <code>FileReader.readAsDataURL</code> method.
		@endslot
	@endcomponent
	...
	@component('components.projects.project-caption')
		...
		@slot('caption')
			Photos could be rotated, scaled, and decorated with a selection of frames on the front-end. Once submitted, the front-end would pass image manipulation values to the PHP back-end, which would use functions such as <code>imagealphablending()</code> and <code>imagefill()</code> in order to render the final bitmap.
		@endslot
	@endcomponent
