...
@section ('project-content')
	...
	@component('components.projects.project-image', ['size' => 'small', 'alt' => 'The Steve Madden app'])
		@slot('image', '/images/projects/steve-madden/steve-madden-image-1.jpg')
	@endcomponent

	@component('components.projects.project-caption')
		@slot('image', '/images/projects/steve-madden/steve-madden-image-2.jpg')
		@slot('caption')
	...
	@component('components.projects.project-caption')
		@slot('image', '/images/projects/steve-madden/steve-madden-image-3.jpg')
		@slot('caption')
	...
	@component('components.projects.project-caption')
		@slot('image', '/images/projects/steve-madden/steve-madden-image-4.jpg')
