		...
		<div id="content">
			...
			<?php if ($page == "project") { ?>
				...
				<div id="intro">
					...
					<h3><span><?php echo $project[$project_name][2]; ?></span><?php if (isset($project[$project_name][6]) == true) { echo " <a href='" . $project[$project_name][6] . "' class='site-link'>View Site <span>&#10095;</span></a>"; }; ?><span class="cf"></span></h3>
