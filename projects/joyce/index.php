...
?>
	...
	<div class="section">
		...
		<p>Lastly but equally as important, support for cross-browser compatibility was vital to the project. Although Joyce's influence spans the world, its roots come from Hong Kong. <a href="http://tongji.baidu.com/data/browser">Up to 30% of users in China still use Internet Explorer 8</a>, therefore solid cross-browser support was a fundamental goal of the project.</p>
	...
	<div class="section">
		...
		<?php project_image("joyce_image_3.jpg", "Stores and brands are inter-connected throughout the website. The directory page features live-searching where results on the right fade out as the user types. The grid of letters on the left also fades out in real-time corresponding to filtered results."); ?>
